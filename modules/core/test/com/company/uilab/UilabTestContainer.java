...
public class UilabTestContainer extends TestContainer {

    public UilabTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/uilab/app.properties",
    ...
    public static class Common extends UilabTestContainer {

        public static final UilabTestContainer.Common INSTANCE = new UilabTestContainer.Common();
